...
import { PHONE_HREF, PHONE_DISPLAY, WHATSAPP_URL } from "@/config/site";
      ...
      <div className="bg-gradient-primary text-primary-foreground py-2">
        <div className="container mx-auto px-4">
          ...
          <div className="hidden md:flex flex-wrap items-center justify-between gap-3 text-sm">
            ...
            <a href={PHONE_HREF} className="flex items-center gap-2 font-bold hover:underline">
            ...
            <a
              ...
              className="hidden md:flex items-center gap-2 font-bold bg-whatsapp text-whatsapp-foreground px-3 py-1 rounded-full hover:opacity-90 transition-opacity"
            >
      ...
      <nav className="container mx-auto px-4 py-4">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <a
              href={PHONE_HREF}
              className="flex items-center gap-1 bg-urgent text-urgent-foreground px-3 py-2 rounded-full font-bold text-sm touch-manipulation active:scale-95 transition-transform min-h-12 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-urgent focus-visible:ring-offset-2"
