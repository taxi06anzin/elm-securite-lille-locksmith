        ...
        <div className="container mx-auto px-4">
          ...
          <section className="py-16 grid md:grid-cols-2 gap-12 items-center">
            <div className="relative h-96 rounded-lg overflow-hidden shadow-elegant">
              <OptimizedImage src={interventionImage} alt="Dépannage serrurier Lomme" className="w-full h-full object-cover" />
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="relative h-80 rounded-lg overflow-hidden shadow-elegant">
                  <OptimizedImage src={changementCylindre} alt="Remplacement cylindre Lomme" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
          </section>

          <InternalLinks currentCity="serrurier-lomme" />
